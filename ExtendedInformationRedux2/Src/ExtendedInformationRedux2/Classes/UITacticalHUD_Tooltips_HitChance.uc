...
{
	return `MCM_CH_GetValue(class'MCM_Defaults'.default.ES_TOOLTIP, class'ExtendedInformationRedux2_MCMScreen'.default.ES_TOOLTIP);
}

function int getTOOLTIP_ALPHA()
{
	return `MCM_CH_GetValue(class'MCM_Defaults'.default.TOOLTIP_ALPHA, class'ExtendedInformationRedux2_MCMScreen'.default.TOOLTIP_ALPHA);
}
