...
class MCM_Defaults extends object config(ExtendedInformationRedux2_MCMDefaults);
...
var config int		DODGE_OFFSET_X;
var config int		CRIT_OFFSET_X;
var config int		CRIT_OFFSET_Y;*/
var config string	HIT_HEX_COLOR;
